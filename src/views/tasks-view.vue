<template>
  <div
    ...
    v-show="isPanelVisible.tasks && $store.state.tasks.permissions.view"
  >
    <h2>Tasks</h2>
    <div
      class="tasks-list"
  ...
  <div
    id="task-add-view"
    data-testid="tasks-add-tasks-view"
    v-show="isPanelVisible.add && $store.state.tasks.permissions.view"
  >
    <h2>Add Task</h2>
    <div>
  ...
  <div
    ...
    v-show="isPanelVisible.edit && $store.state.tasks.permissions.view"
  >
    <h2>Edit Task</h2>
    <div>
      <div class="label">Name:</div>
  ...
  <div
    ...
    v-show="isPanelVisible.list && $store.state.tasks.permissions.view"
  >
    <h2>Tasklist</h2>
    <h3>Open Tasks</h3>
    <div
